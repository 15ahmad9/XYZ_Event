...
if (isset($_POST['name'], $_POST['password'])) {
    ...
    $stmt = $connection->prepare("SELECT * FROM organizer WHERE name = ? AND password = ?");
...
<body>
    <div class="container">
        <form class="login-form" action="organizer-login.php" method="POST">
            ...
            <hr>
            <p class="create-account-text">Don't have an account? <a href="organizer-register.php">Create an account</a></p>
            <p class="create-account-text">Are you an attendee? <a href="index.php">Attendee Login</a></p>
        </form>
