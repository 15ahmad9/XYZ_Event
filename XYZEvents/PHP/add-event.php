...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sqlEvent = "INSERT INTO event (name, type, capacity, locations, description, ticketPrice, organizerID) VALUES ('$name', '$type', '$capacity', '$location', '$description', '$ticketPrice', '$organizerID')";
